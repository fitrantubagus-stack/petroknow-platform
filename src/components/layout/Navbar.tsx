...
import { 
  ...
  AlertTriangle, Check, Layers, Compass, Menu, X 
} from 'lucide-react';
...
export const Navbar: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-slate-900/95 backdrop-blur-md border-b border-slate-800 text-slate-100 flex flex-col justify-center overflow-x-hidden">
      <div className="h-16 w-full flex items-center justify-between px-2.5 sm:px-6 min-w-0">
        ...
        <div className="flex items-center gap-1.5 sm:gap-3 shrink-0">
          ...
          <div className="relative" ref={notifRef}>
            ...
            {notificationsOpen && (
              <div className="absolute right-0 mt-2 w-72 sm:w-80 bg-slate-900 border border-slate-700 rounded-xl shadow-2xl p-3 z-50 animate-fade-in text-xs space-y-2">
